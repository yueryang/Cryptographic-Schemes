...
class Parser:
	...
	def __printHelp(self:object) -> None:
		print("This is the official implementation of the LB-PEAKS cryptographic scheme in Python programming language based on the Python NumPy and SymPy libraries. ")
		print()
