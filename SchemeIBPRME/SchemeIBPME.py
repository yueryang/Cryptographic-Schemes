...
class Parser:
	...
	def __printHelp(self:object) -> None:
		print("This is a possible implementation of the IBPME cryptography scheme in Python programming language based on the Python charm library. \n")
...
def conductScheme(curveType:tuple|list|str, run:int|None = None) -> list:
	...
	try:
		...
		return (																																														\
			...
			+ [run if isinstance(run, int) and run >= 1 else None] + [False] * 4 + [-1] * 19																																	\
		)
