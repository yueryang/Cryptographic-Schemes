...
class Parser:
	...
	def __printHelp(self:object) -> None:
		print("This is the official simulation implementation of the FS-LLRS cryptographic scheme in Python programming language based on the Python NumPy library. ")
		print()
