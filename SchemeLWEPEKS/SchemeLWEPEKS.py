...
class Parser:
	...
	def __printHelp() -> None:
		print("This is the official simulation implementation of the LWE-PEKS cryptographic scheme in the Python programming language based on the Python NumPy library. ")
		print()
